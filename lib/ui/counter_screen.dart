      ...
      body:  Column(
        ...
        children: [
          BlocBuilder<CounterBloc, CounterState>(builder: (context, state) {
            return  Center(child: Text(state.counter.toString(), style: TextStyle(fontSize: 22),));
          },),
         Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
            ElevatedButton(onPressed:() {
              context.read<CounterBloc>().add(PlusCounter());
            }, child: Text("plus")),
            SizedBox(width: 20,),
            ElevatedButton(onPressed:() {
              context.read<CounterBloc>().add(MinusCounter());
            }, child: Text("minus")),
          ],)
        ],
      ),
